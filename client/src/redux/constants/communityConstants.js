...
export const DELETE_RULE_FROM_COMMUNITY_SUCCESS =
  "DELETE_RULE_FROM_COMMUNITY_SUCCESS";
export const DELETE_RULE_FROM_COMMUNITY_FAIL =
  "DELETE_RULE_FROM_COMMUNITY_FAIL";
