  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="user-page-head">
        <p className="user-page-title">{name}</p>
        <p className="user-page-subtitle">{bio || userLocation || "No bio added"}</p>
      </div>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="flex flex-col gap-4 md:col-span-1">
          <div className="profile-card">
            <div className="profile-card-banner" />
            <div className="profile-card-body py-6">
              <div className="flex flex-col items-center justify-center bg-white py-6">
                <div className="relative">
                  <img
                    className="profile-card-avatar mr-4 h-20 w-20"
                    src={avatar}
                    alt="Profile"
                    loading="lazy"
                  />
              ...
              <div>
                <h1 className="profile-card-name mt-3 text-center text-lg capitalize">
                  {name}
                </h1>
